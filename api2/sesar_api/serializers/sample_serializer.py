...
class SampleLandingPageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Sample
        fields = ['igsn', 'name', 'sesar_code', 'parent_sample', 'sample_type',  'publish_date', 'last_update_date', 'size', 'general_material_type', 'sample_material', 'material_name_verbatim', 'sample_description', 'purpose', 'geologic_age_verbatim', 'numeric_age_min', 'numeric_age_max', 'numeric_age_unit','geologic_age_younger', 'geologic_age_older', 'geologic_unit', 'age_qualifier', 'latitude', 'longitude', 'latitude_end', 'longitude_end', 'depth_min', 'depth_max', 'depth_uom', 'depth_spatial_ref', 'elevation', 'elevation_uom', 'location_method', 'location_qualifier', 'sampled_feature_type', 'locality', 'locality_label', 'locality_detail', 'collection_method', 'collection_method_detail', 'cruise_field_prgrm', 'individual_collector', 'institution_collector', 'platform', 'launch_platform', 'launch_label', 'collection_start_date', 'collection_end_date', 'collection_date_precision', 'cur_registrant', 'children_igsns', 'sibling_igsns', 'other_names', 'registration_date', 'current_archive', 'original_archive', 'related_resources', 'publication_urls']
