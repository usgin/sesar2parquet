...
urlpatterns = [
    ...
    path('team/<str:name>/sesarcodes/', views.view_team_sesar_codes),
    ...
    path('sesarcode/', views.view_user_sesar_codes),
    path('sesarcode/create/', views.create_sesar_code),
    path('sesarcode/delete/', views.delete_sesar_code),
    path('sesarcode/<str:sesar_code>/', views.view_sesar_code),
