...
class CanGrantSamplePermission(permissions.BasePermission):
    ...
    def __init__(self, group=None, permissions_to_grant=[]):
        ...
        self.group = group
        self.permissions_to_grant = permissions_to_grant
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if self.group and GroupMember.objects.filter(
            ...
            if permission and permission.auth_group:
                ...
                for new_permission in self.permissions_to_grant:
                    if not permission.auth_group.permissions.filter(codename=new_permission).exists():
