...
## Sample
	...
	### geospatial_Location table generate from northing, easting, zone
...
## agents
	decouple sesar_users from full list of all individuals/ogranizations related to samples. preserver ids if poossible.
